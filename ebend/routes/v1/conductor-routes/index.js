...
const { GET_PassengersInBus } = require('../../../controllers/conductor/cond-passenger-logs');
...
// Passenger logs
conductorRouter.get("/passenger-logs", authCondutorMiddleware, GET_PassengersInBus);
