...
const POST_PassengerPayment = async (req, res) => {
    ...
    console.log("APP_FE_URL : ", APP_FE_URL);
    ...
    try {
        ...
        console.log("🚀 ~ constPOST_PassengerPayment= ~ normalPayLoad:", normalPayLoad)
        ...
        // console.log("🚀 ~ constPOST_PassengerPayment= ~ response:", response)

        return successResponse(res, 200, "Payment portal.", response.data.data)


    } catch (error) {
        // console.log("🚀 ~ constPOST_PassengerPayment= ~ error:", error)
        // console.log(error)
        return errorResponse(res, 500, "Error while payment request", error);
    }
};
